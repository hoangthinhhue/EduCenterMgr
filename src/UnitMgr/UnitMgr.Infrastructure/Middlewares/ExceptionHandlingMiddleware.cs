...
namespace UnitMgr.Infrastructure.Configs.Middlewares;
...
public class ExceptionHandlingMiddleware : IMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, RequestDelegate next)
    {
        ...
        catch (Exception exception)
        {
            ...
            var responseModel =  MethodResult.ResultWithError(new string[] { exception.Message });
            ...
            switch (exception)
            {
                case CustomException e:
                    ...
                    {
                        responseModel.Message = string.Join(Environment.NewLine, e.ErrorMessages);
                    }
                    break;
