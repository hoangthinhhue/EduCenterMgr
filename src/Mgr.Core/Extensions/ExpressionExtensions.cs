...
{    public static Expression<Func<T, bool>> FromFilter<T>(IList<FilterParams> filters)
    {
        ...
        if (filters != null && filters.Any())
        {
            ...
            {
                if (Enum.TryParse(filter.FilterOption, out OperationExpression op) && !string.IsNullOrEmpty(filter.FilterValue))
                {
                    var expression = GetCriteriaWhere<T>(filter.ColumnName, op, filter.FilterValue);
    ...
    public static string GetOperand<T>(Expression<Func<T, object>> exp)
    {
    ...
    public static MemberExpression GetMemberExpression<T>(ParameterExpression parameter, string propName)
    {
    ...
    public static Expression<Func<T, bool>> Includes<T>(object fieldValue, ParameterExpression parameterExpression, MemberExpression memberExpression, Type type)
    {
    ...
    public static Expression<Func<T, bool>> Between<T>(object fieldValue, ParameterExpression parameterExpression, MemberExpression memberExpression, Type type)
    {
    ...
    public static Expression<Func<T, bool>> Any<T, T2>(object fieldValue, ParameterExpression parameterExpression, MemberExpression memberExpression)
    {
    ...
    public static PropertyDescriptor GetProperty(PropertyDescriptorCollection props, string fieldName, bool ignoreCase)
    {
