...
{
    public class DeleteBaseCommand<TkeyKey> : IRequest<MethodResult<int>> where TkeyKey : struct
    {
        public TkeyKey Id { get; set; }
    }

    public class DeleteBaseCommandHandler<TDbContext, T, TkeyKey>
       : BaseCommand<TDbContext, T>, IRequestHandler<DeleteBaseCommand<TkeyKey>, MethodResult<int>>
         ...
         where TkeyKey : struct
    {
        ...
        public async Task<MethodResult<int>> Handle(DeleteBaseCommand<TkeyKey> request, CancellationToken cancellationToken)
        {
